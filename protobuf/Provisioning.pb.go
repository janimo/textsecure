...
func (*ProvisionEnvelope) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*ProvisionMessage) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func init() { proto.RegisterFile("Provisioning.proto", fileDescriptor0) }
